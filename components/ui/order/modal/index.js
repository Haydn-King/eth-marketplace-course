...
const createFormState = (
  ...
  if (isNewPurchase) {
    if (confirmationEmail.length === 0 || email.length === 0) {
      return _createFormState(true, "Please provide a confirmation email!");
  ...
  if (!hasAgreedTOS) {
    return _createFormState(
      true,
      "Please accept the Terms of Service to submit the form!"
    );
  }
  return _createFormState();
};
            ...
            <div className="sm:flex sm:items-start">
              <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-1 relative rounded-md">
                  <div className="mb-1">
                    ...
                    <div className="text-xs text-gray-700 flex">
                      ...
                      <span>
                        Adjust Price - Only if and when the price is not correct
                      </span>
                    </div>
                  </div>
                  <input
                  ...
                  <p className="text-xs text-gray-700">
                    ...
                    price has been lowered, then your order may be declined. (+-
                  ...
                  <>
                    <div className="mt-2 relative rounded-md">
                      ...
                      <p className="text-xs text-gray-700 mt-1">
                        It&apos;s important to fill in a correct email,
                ...
                <div className="text-xs text-gray-700 flex mt-5">
                  ...
                  <span>
                    I accept Heathendustries &apos;terms of service&apos; and I
                    agree that my order can be rejected in the case data
                    provided above is not correct.
                  </span>
                </div>
                {formState.message && (
